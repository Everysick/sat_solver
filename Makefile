...
srcdir = .
topdir = /Users/everysick/Documents/cruby/include/ruby-2.2.0
hdrdir = $(topdir)
arch_hdrdir = /Users/everysick/Documents/cruby/include/ruby-2.2.0/x86_64-darwin13
PATH_SEPARATOR = :
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = $(DESTDIR)/Users/everysick/Documents/cruby
...
target_prefix = 
LOCAL_LIBS = 
LIBS =  -lstdc++  -lpthread -lgmp -ldl -lobjc 
ORIG_SRCS = sat.cpp solver.cpp
SRCS = $(ORIG_SRCS) 
OBJS = sat.o solver.o
HDRS = $(srcdir)/solver.h
TARGET = SATSolver
TARGET_NAME = SATSolver
